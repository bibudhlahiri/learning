...
posText <- read.delim(file='/Users/blahiri/sentiment_models/rt-polaritydata/rt-polaritydata/rt-polarity-pos.txt', header=FALSE, stringsAsFactors=FALSE)
posText <- posText$V1
posText <- unlist(lapply(posText, function(x) { str_split(x, "\n") }))
negText <- read.delim(file='/Users/blahiri/sentiment_models/rt-polaritydata/rt-polaritydata/rt-polarity-neg.txt', header=FALSE, stringsAsFactors=FALSE)
negText <- negText$V1
negText <- unlist(lapply(negText, function(x) { str_split(x, "\n") }))

#load up word polarity list and format it
afinn_list <- read.delim(file='/Users/blahiri/sentiment_models/AFINN/AFINN-111.txt', header=FALSE, stringsAsFactors=FALSE)
